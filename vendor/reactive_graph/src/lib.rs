...
// Patched in Orbital: SSR/hydrate emit spurious "outside a reactive tracking context"
// warnings on every correct dynamic attribute read during the one-shot to_html pass.
// Real reactivity bugs are caught by Playwright interaction tests and hydration errors.
#[allow(unused)]
#[doc(hidden)]
pub fn log_warning(_text: Arguments) {}
